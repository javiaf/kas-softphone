...
public class Actions {
	...
	public final static String INCOMING_CALL = EndPointEvent.INCOMING_CALL.toString();
	...
	public final static String CALL_TERMINATE = CallEvent.CALL_TERMINATE.toString();
