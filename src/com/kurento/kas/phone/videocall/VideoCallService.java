...
public class VideoCallService extends Service {
	...
	public void onCreate() {
		...
		try {
			Direction audioDirection = callDirectionMap.get(MediaType.AUDIO);

			if ((audioDirection != null)
					&& (Direction.SENDONLY.equals(audioDirection) || Direction.SENDRECV
							.equals(audioDirection))) {
			...
			if ((audioDirection != null)
					&& (Direction.RECVONLY.equals(audioDirection) || Direction.SENDRECV
							.equals(audioDirection))) {
	...
	public void onStart(Intent intent, int startId) {
		...
		try {
			...
			if (audioPlayerComponent != null) {
				audioPlayerComponent.join(Joinable.Direction.SEND, audioJoinable);
				audioPlayerComponent.start();
			}

			if (audioRecorderComponent != null) {
				audioRecorderComponent.join(Joinable.Direction.RECV, audioJoinable);
